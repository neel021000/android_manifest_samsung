...
echo ""
echo "Building"
. build/envsetup.sh ; lunch omni_on7xelte-eng ; mka recoveryimage
echo ""
echo "+++++++++++++++"
echo "+     J5      +"
echo "+++++++++++++++"
...
echo ""
echo "Building"
. build/envsetup.sh ; lunch omni_j5y17lte-eng ; mka recoveryimage
echo ""
echo "+++++++++++++++"
echo "+   J7Pro     +"
echo "+++++++++++++++"
...
echo ""
echo "Building"
. build/envsetup.sh ; lunch omni_j7y17lte-eng ; mka recoveryimage
echo ""
echo "+++++++++++++++"
echo "+    J7NXT    +"
echo "+++++++++++++++"
...
echo ""
echo "Building"
. build/envsetup.sh ; lunch omni_j7velte-eng ; mka recoveryimage
make clean
echo ""
echo "+++++++++++++++"
echo "+   J7 16     +"
...
echo ""
echo "Building"
. build/envsetup.sh ; lunch omni_j7xelte-eng ; mka recoveryimage
echo ""
echo "+++++++++++++++"
echo "+      A3     +"
echo "+++++++++++++++"
...
echo ""
echo "Building"
. build/envsetup.sh ; lunch omni_a3y17lte-eng ; mka recoveryimage
elif [ $n -eq 2 ]; then
exit
fi
